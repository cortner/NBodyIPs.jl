...
function fba(x::SVector{10,T}) where {T}
   ...
   I21 = ((x[1]*x2[5]*x[6] + x[1]*x2[5]*x[7] + x[1]*x[5]*x2[6] + x[1]*x[5]*x2[7] + x[1]*x2[6]*x[7] + x[1]*x[6]*x2[7]) +
      (x[2]*x2[5]*x[8] + x[2]*x2[5]*x[9] + x[2]*x[5]*x2[8] + x[2]*x[5]*x2[9] + x[2]*x2[8]*x[9] + x[2]*x[8]*x2[9]) +
      (x[3]*x2[6]*x[8] + x[3]*x2[6]*x[10] + x[3]*x[6]*x2[8] + x[3]*x[6]*x2[10] + x[3]*x2[8]*x[10] + x[3]*x[8]*x2[10]) +
      (x[4]*x2[7]*x[9] + x[4]*x2[7]*x[10] + x[4]*x[7]*x2[9] + x[4]*x[7]*x2[10] + x[4]*x2[9]*x[10] + x[4]*x[9]*x2[10]))

   I22 = ((x[1]*x2[5]*x[8] + x[1]*x2[5]*x[9] + x[1]*x2[6]*x[8] + x[1]*x2[6]*x[10] + x[1]*x2[7]*x[9] + x[1]*x2[7]*x[10]) +
      (x[2]*x2[5]*x[6] + x[2]*x2[5]*x[7] + x[2]*x[6]*x2[8] + x[2]*x[7]*x2[9] + x[2]*x2[8]*x[10] + x[2]*x2[9]*x[10]) +
      (x[3]*x[5]*x2[6] + x[3]*x[5]*x2[8] + x[3]*x2[6]*x[7] + x[3]*x[7]*x2[10] + x[3]*x2[8]*x[9] + x[3]*x[9]*x2[10]) +
      (x[4]*x[5]*x2[7] + x[4]*x[5]*x2[9] + x[4]*x[6]*x2[7] + x[4]*x[6]*x2[10] + x[4]*x[8]*x2[9] + x[4]*x[8]*x2[10]))
   ...
   I28 = x[1]*x[2]*x3[5] + x[1]*x[3]*x3[6] + x[1]*x[4]*x3[7] + x[2]*x[3]*x3[8] + x[2]*x[4]*x3[9] + x[3]*x[4]*x3[10]

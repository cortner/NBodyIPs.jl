...
return (@SVector [P1,P2,P3,P4,P5,P6,P7,P8,P9,P10,IS1, IS2, IS3, IS4, IS5, IS6, IS7, IS8, IS9, IS10, IS11, IS12, IS13, IS14, IS15, IS16, IS17, IS18, IS19, IS20, IS21, IS22, IS23, IS24, IS25, IS26, IS27, IS28, IS29, IS30, IS31, IS32, IS33, IS34, IS35, IS36, IS37, IS38, IS39, IS40, IS41, IS42, IS43, IS44, IS45, IS46])
end
...
function push_monomial!(exprs, syms, pows, vars)
   ...
   s1 = push_monomial!(exprs, syms, pows[2:end], vars[2:end])
   s2 = push_monomial!(exprs, syms, pows[1:1], vars[1:1])
   push!(exprs, :($(s) = $(s1)*$(s2)))
   push!(syms, s)
   return s
end
...
@generated function invnew(x1::SVector{10, T}) where {T}
   ...
   push!(exprs, :((@SVector [p1,p2,p3,p4,p5,p6,p7,p8,p9,p10, is1, is2, is3, is4, is5, is6, is7, is8, is9, is10, is11, is12, is13, is14, is15, is16, is17, is18, is19, is20, is21, is22, is23, is24, is25, is26, is27, is28, is29, is30, is31, is32, is33, is34, is35, is36, is37, is38, is39, is40, is41, is42, is43, is44, is45, is46])))

...
x[2]*x[3]*x[8]*x[7] + x[1]*x[8]*x[4]*x[7] + 
x[1]*x[3]*x[6]*x[9] + x[2]*x[6]*x[4]*x[9] + 
x[5]*x[3]*x[7]*x[9] + x[1]*x[2]*x[5]*x[10] + 
x[5]*x[3]*x[4]*x[10] + x[2]*x[6]*x[7]*x[10] + 
x[1]*x[8]*x[9]*x[10]
...
x[2]*x[8]*x[4]*x[7]*x[9] + 
x[5]*x[8]*x[4]*x[7]*x[9] + 
x[1]*x[2]*x[3]*x[6]*x[10] + 
x[1]*x[5]*x[3]*x[6]*x[10] + 
x[1]*x[2]*x[3]*x[8]*x[10] + 
x[2]*x[5]*x[3]*x[8]*x[10] + 
x[1]*x[5]*x[6]*x[8]*x[10] + 
x[2]*x[5]*x[6]*x[8]*x[10] + 
x[2]*x[3]*x[6]*x[4]*x[10] + 
x[1]*x[3]*x[8]*x[4]*x[10] + 
x[5]*x[3]*x[6]*x[7]*x[10] + 
x[1]*x[6]*x[8]*x[7]*x[10] + 
x[1]*x[2]*x[4]*x[7]*x[10] + 
x[1]*x[5]*x[4]*x[7]*x[10] + 
x[2]*x[3]*x[4]*x[7]*x[10] + 
x[5]*x[6]*x[4]*x[7]*x[10] + 
x[3]*x[8]*x[4]*x[7]*x[10] + 
x[6]*x[8]*x[4]*x[7]*x[10] + 
x[5]*x[3]*x[8]*x[9]*x[10] + 
x[2]*x[6]*x[8]*x[9]*x[10] + 
x[1]*x[2]*x[4]*x[9]*x[10] + 
x[2]*x[5]*x[4]*x[9]*x[10] + 
x[1]*x[3]*x[4]*x[9]*x[10] + 
x[3]*x[6]*x[4]*x[9]*x[10] + 
x[5]*x[8]*x[4]*x[9]*x[10] + 
x[6]*x[8]*x[4]*x[9]*x[10] + 
x[1]*x[5]*x[7]*x[9]*x[10] + 
x[2]*x[5]*x[7]*x[9]*x[10] + 
x[1]*x[6]*x[7]*x[9]*x[10] + 
x[3]*x[6]*x[7]*x[9]*x[10] + 
x[2]*x[8]*x[7]*x[9]*x[10] + 
x[3]*x[8]*x[7]*x[9]*x[10]
